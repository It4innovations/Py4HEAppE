...
### Changed
- Updated Py4HEAppE wrapper to support new changes in HEAppE V6.5.0 [See HEAppE v6.4.0 CHANGELOG.md](https://github.com/It4innovations/HEAppE/blob/master/CHANGELOG.md#v650)
