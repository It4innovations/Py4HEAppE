...
class FileTransferApi(object):
    ...
    def heappe_file_transfer_upload_files_to_job_execution_dir_post(self, **kwargs):  # noqa: E501
        """Upload job to file to job execution dir  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_file_transfer_upload_files_to_job_execution_dir_post(async_req=True)
        >>> result = thread.get()
        ...
        :param int JobId:
        :param int TaskId:
        :return: list[FileUploadResultExt]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.heappe_file_transfer_upload_files_to_job_execution_dir_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.heappe_file_transfer_upload_files_to_job_execution_dir_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def heappe_file_transfer_upload_files_to_job_execution_dir_post_with_http_info(self, **kwargs):  # noqa: E501
        """Upload job to file to job execution dir  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_file_transfer_upload_files_to_job_execution_dir_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['files', 'SessionCode', 'JobId', 'TaskId']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method heappe_file_transfer_upload_files_to_job_execution_dir_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'TaskId' in params:
            query_params.append(('TaskId', params['TaskId']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/heappe/FileTransfer/UploadFilesToJobExecutionDir', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[FileUploadResultExt]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
