...
class ManagementApi(object):
    ...
    def heappe_management_backup_database_post(self, SessionCode, **kwargs):  # noqa: E501
        """Full backup database  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_management_backup_database_post(SessionCode, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.heappe_management_backup_database_post_with_http_info(SessionCode, **kwargs)  # noqa: E501
        else:
            (data) = self.heappe_management_backup_database_post_with_http_info(SessionCode, **kwargs)  # noqa: E501
            return data

    def heappe_management_backup_database_post_with_http_info(self, SessionCode, **kwargs):  # noqa: E501
        """Full backup database  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_management_backup_database_post_with_http_info(SessionCode, async_req=True)
        >>> result = thread.get()
        ...
        if ('SessionCode' not in params or
            ...
            raise ValueError("Missing the required parameter `SessionCode` when calling `heappe_management_backup_database_post`")  # noqa: E501
