...
class ClusterInformationApi(object):
    ...
    def heappe_cluster_information_list_available_clusters_clear_cache_post(self, **kwargs):  # noqa: E501
        """heappe_cluster_information_list_available_clusters_clear_cache_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_cluster_information_list_available_clusters_clear_cache_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.heappe_cluster_information_list_available_clusters_clear_cache_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.heappe_cluster_information_list_available_clusters_clear_cache_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def heappe_cluster_information_list_available_clusters_clear_cache_post_with_http_info(self, **kwargs):  # noqa: E501
        """heappe_cluster_information_list_available_clusters_clear_cache_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.heappe_cluster_information_list_available_clusters_clear_cache_post_with_http_info(async_req=True)
        >>> result = thread.get()
