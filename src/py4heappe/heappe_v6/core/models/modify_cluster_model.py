...
class ModifyClusterModel(object):
    ...
    def __init__(self, session_code=None, id=None, name=None, description=None, master_node_name=None, scheduler_type=None, connection_protocol=None, time_zone=None, port=None, update_job_state_by_service_account=None, domain_name=None, proxy_connection_id=None, custom_configuration=None):  # noqa: E501
