...
class CreateProjectModel(object):
    ...
    def __init__(self, session_code=None, name=None, description=None, accounting_string=None, start_date=None, end_date=None, usage_type=None, use_accounting_string_for_scheduler=None, pi_email=None, is_one_to_one_mapping=None, _configuration=None):  # noqa: E501
