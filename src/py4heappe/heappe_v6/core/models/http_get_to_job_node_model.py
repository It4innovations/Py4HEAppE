...
class HttpGetToJobNodeModel(object):
    ...
    def __init__(self, session_code=None, submitted_task_info_id=None, http_request=None, http_headers=None, node_ip_address=None, node_port=None, _configuration=None):  # noqa: E501
