...
class ExtendedClusterExt(object):
    ...
    def __init__(self, id=None, name=None, description=None, master_node_name=None, scheduler_type=None, time_zone=None, port=None, connection_protocol=None, update_job_state_by_service_account=None, domain_name=None, proxy_connection=None, file_transfer_method_ids=None, node_types=None, _configuration=None):  # noqa: E501
