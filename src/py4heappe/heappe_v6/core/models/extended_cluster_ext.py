...
class ExtendedClusterExt(object):
    ...
    swagger_types = {
        ...
        'custom_configuration': 'dict(str, str)',
        'custom_configuration_vault_toggles': 'dict(str, bool)',
        'use_callback': 'bool'
    }
    ...
    attribute_map = {
        ...
        'custom_configuration_vault_toggles': 'CustomConfigurationVaultToggles',
        'use_callback': 'UseCallback'
    }

    def __init__(self, id=None, name=None, description=None, master_node_name=None, scheduler_type=None, time_zone=None, port=None, connection_protocol=None, update_job_state_by_service_account=None, domain_name=None, proxy_connection=None, file_transfer_method_ids=None, node_types=None, custom_configuration=None, custom_configuration_vault_toggles=None, use_callback=None):  # noqa: E501
        ...
        self._custom_configuration_vault_toggles = None
        self._use_callback = None
        ...
        if custom_configuration_vault_toggles is not None:
            self.custom_configuration_vault_toggles = custom_configuration_vault_toggles
        if use_callback is not None:
    ...
    def custom_configuration(self):
        """Gets the custom_configuration of this ExtendedClusterExt.  # noqa: E501

        Custom configuration  # noqa: E501

        :return: The custom_configuration of this ExtendedClusterExt.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._custom_configuration

    @custom_configuration.setter
    def custom_configuration(self, custom_configuration):
        """Sets the custom_configuration of this ExtendedClusterExt.

        Custom configuration  # noqa: E501

        :param custom_configuration: The custom_configuration of this ExtendedClusterExt.  # noqa: E501
        :type: dict(str, str)
        """
    ...
    @property
    def custom_configuration_vault_toggles(self):
        """Gets the custom_configuration_vault_toggles of this ExtendedClusterExt.  # noqa: E501

        Custom configuration vault toggles  # noqa: E501

        :return: The custom_configuration_vault_toggles of this ExtendedClusterExt.  # noqa: E501
        :rtype: dict(str, bool)
        """
        return self._custom_configuration_vault_toggles

    @custom_configuration_vault_toggles.setter
    def custom_configuration_vault_toggles(self, custom_configuration_vault_toggles):
        """Sets the custom_configuration_vault_toggles of this ExtendedClusterExt.

        Custom configuration vault toggles  # noqa: E501

        :param custom_configuration_vault_toggles: The custom_configuration_vault_toggles of this ExtendedClusterExt.  # noqa: E501
        :type: dict(str, bool)
        """

        self._custom_configuration_vault_toggles = custom_configuration_vault_toggles

    @property
    def use_callback(self):
        """Gets the use_callback of this ExtendedClusterExt.  # noqa: E501

        Use callback  # noqa: E501

        :return: The use_callback of this ExtendedClusterExt.  # noqa: E501
        :rtype: bool
        """
        return self._use_callback

    @use_callback.setter
    def use_callback(self, use_callback):
        """Sets the use_callback of this ExtendedClusterExt.

        Use callback  # noqa: E501

        :param use_callback: The use_callback of this ExtendedClusterExt.  # noqa: E501
        :type: bool
        """
